                      ...
                      if (!vatExempt) ...[
                        ...
                        pw.Row(
                          ...
                          children: [
                            ...
                            pw.Text('₪${totalWithVat.toStringAsFixed(2)}', style: pw.TextStyle(fontSize: 14, fontWeight: pw.FontWeight.bold, color: brandTerracotta)),
                          ],
                        ),
                      ] else ...[
                        pw.Row(
                        ...
                        pw.Row(
                          mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                          children: [
                            pw.Text('פטור ממע"מ', style: pw.TextStyle(fontSize: 8, color: textMuted)),
                            pw.Text('עוסק פטור', style: pw.TextStyle(fontSize: 8, color: textMuted)),
                          ],
                        ),
                      ],
                    ],
