...
Future<Uint8List> buildModernBordeauxPdf({
          ...
          child: pw.Column(
            ...
            children: [
              ...
              pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
                  buildSignatureLine('חתימת בית העסק', brandBordeaux, textMuted),
                  buildSignatureLine('חתימת הלקוח לאישור', brandBordeaux, textMuted),
                ],
              ),
            ],
          ),
